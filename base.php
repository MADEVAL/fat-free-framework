...
require __DIR__.'/base/Registry.php';
require __DIR__.'/base/Prefab.php';
require __DIR__.'/base/Cache.php';
require __DIR__.'/base/View.php';
require __DIR__.'/base/Preview.php';
require __DIR__.'/base/ISO.php';
...
final class Base extends Prefab implements ArrayAccess {
	...
	//@{ Framework details
	const
		PACKAGE='Fat-Free Framework Modern',
		VERSION='3.9.2.2';
	//@}
